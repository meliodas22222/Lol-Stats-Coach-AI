export default async function handler(req, res) {
  ...
  try {
    ...
    const soloQ = (Array.isArray(league) ? league : []).find(e => e.queueType === "RANKED_SOLO_5x5") || { tier: "Unranked", rank: "" };
    ...
    res.status(200).json({ gameName: acc.gameName, rank: soloQ.tier, division: soloQ.rank, matches });
